...
export function Search({
  ...
  return (
    <Button
      ...
      variant='outline'
      className={cn(
        'group relative h-8 pointer-coarse:min-h-11 w-full flex-1 justify-start rounded-md bg-muted/25 text-sm font-normal text-muted-foreground shadow-none hover:bg-accent sm:w-40 sm:pe-12 md:flex-none lg:w-52 xl:w-64',
        className
      )}
